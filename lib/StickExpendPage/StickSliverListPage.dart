...
class StickSliverListPage extends StatefulWidget {
  final List<ExpendedModel> dataList = List.generate(7, (index) {
    return ExpendedModel(false, List(random.nextInt(100)));
  });

  @override
  _StickSliverListPageState createState() => _StickSliverListPageState();
}

class _StickSliverListPageState extends State<StickSliverListPage> {
  int _titleIndex = 0;
